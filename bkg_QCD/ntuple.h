...
// Tue Jan 19 14:45:23 2016 by ROOT version 5.34/32
// from TTree TauCheck/TauCheck
// found on file: /data/jbrandstetter/CMGTools/rootFiles_160114/BASIS_ntuple_synchro_Run2015D_mt.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/jbrandstetter/CMGTools/rootFiles_160114/BASIS_ntuple_synchro_Run2015D_mt.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/jbrandstetter/CMGTools/rootFiles_160114/BASIS_ntuple_synchro_Run2015D_mt.root");
      }
