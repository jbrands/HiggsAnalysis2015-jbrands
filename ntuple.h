...
public :
   ...
   Int_t           ngen;
   Double_t        gen_charge[133];   //[ngen]
   Int_t           gen_status[133];   //[ngen]
   Int_t           gen_isPrompt[133];   //[ngen]
   Int_t           gen_isPromptFinalState[133];   //[ngen]
   Int_t           gen_isDirectPromptTauDecayProduct[133];   //[ngen]
   Int_t           gen_isDirectPromptTauDecayProductFinalState[133];   //[ngen]
   Int_t           gen_pdgId[133];   //[ngen]
   Double_t        gen_pt[133];   //[ngen]
   Double_t        gen_eta[133];   //[ngen]
   Double_t        gen_phi[133];   //[ngen]
   Double_t        gen_mass[133];   //[ngen]
   Int_t           gen_motherId[133];   //[ngen]
   Int_t           gen_grandmotherId[133];   //[ngen]
   Int_t           ntriggerObject_Ele22;
   Double_t        triggerObject_Ele22_eta[2];   //[ntriggerObject_Ele22]
   Double_t        triggerObject_Ele22_phi[2];   //[ntriggerObject_Ele22]
   Double_t        triggerObject_Ele22_pdgId[2];   //[ntriggerObject_Ele22]
   Double_t        triggerObject_Ele22_pt[2];   //[ntriggerObject_Ele22]
   Int_t           ntriggerObject_IsoMu17;
   Double_t        triggerObject_IsoMu17_eta[3];   //[ntriggerObject_IsoMu17]
   Double_t        triggerObject_IsoMu17_phi[3];   //[ntriggerObject_IsoMu17]
   Double_t        triggerObject_IsoMu17_pdgId[3];   //[ntriggerObject_IsoMu17]
   Double_t        triggerObject_IsoMu17_pt[3];   //[ntriggerObject_IsoMu17]
   Int_t           ngenSum;
   Int_t           genSum_motherId[39];   //[ngenSum]
   Int_t           genSum_grandmotherId[39];   //[ngenSum]
   Int_t           genSum_sourceId[39];   //[ngenSum]
   Double_t        genSum_charge[39];   //[ngenSum]
   Int_t           genSum_status[39];   //[ngenSum]
   Int_t           genSum_isPrompt[39];   //[ngenSum]
   Int_t           genSum_isPromptFinalState[39];   //[ngenSum]
   Int_t           genSum_isDirectPromptTauDecayProduct[39];   //[ngenSum]
   Int_t           genSum_isDirectPromptTauDecayProductFinalState[39];   //[ngenSum]
   Int_t           genSum_pdgId[39];   //[ngenSum]
   Double_t        genSum_pt[39];   //[ngenSum]
   Double_t        genSum_eta[39];   //[ngenSum]
   Double_t        genSum_phi[39];   //[ngenSum]
   Double_t        genSum_mass[39];   //[ngenSum]
   Int_t           genSum_motherIndex[39];   //[ngenSum]
   ...
   Int_t           njet;
   Double_t        jet_area[10];   //[njet]
   Double_t        jet_qgl[10];   //[njet]
   Double_t        jet_ptd[10];   //[njet]
   Double_t        jet_axis2[10];   //[njet]
   Int_t           jet_mult[10];   //[njet]
   Int_t           jet_partonId[10];   //[njet]
   Int_t           jet_partonMotherId[10];   //[njet]
   Double_t        jet_nLeptons[10];   //[njet]
   Int_t           jet_id[10];   //[njet]
   Int_t           jet_puId[10];   //[njet]
   Double_t        jet_puIdMVAoutput[10];   //[njet]
   Double_t        jet_btagCSV[10];   //[njet]
   Double_t        jet_btagCMVA[10];   //[njet]
   Double_t        jet_rawPt[10];   //[njet]
   Double_t        jet_mcPt[10];   //[njet]
   Int_t           jet_mcFlavour[10];   //[njet]
   Int_t           jet_mcMatchId[10];   //[njet]
   Double_t        jet_corr_JECUp[10];   //[njet]
   Double_t        jet_corr_JECDown[10];   //[njet]
   Double_t        jet_corr[10];   //[njet]
   Double_t        jet_pt[10];   //[njet]
   Double_t        jet_eta[10];   //[njet]
   Double_t        jet_phi[10];   //[njet]
   Double_t        jet_mass[10];   //[njet]
   ...
   Double_t        triggerObject_IsoMu18_eta[1];   //[ntriggerObject_IsoMu18]
   Double_t        triggerObject_IsoMu18_phi[1];   //[ntriggerObject_IsoMu18]
   Double_t        triggerObject_IsoMu18_pdgId[1];   //[ntriggerObject_IsoMu18]
   Double_t        triggerObject_IsoMu18_pt[1];   //[ntriggerObject_IsoMu18]
   Int_t           nel;
   Int_t           el_charge[3];   //[nel]
   Int_t           el_tightId[3];   //[nel]
   Int_t           el_eleCutIdCSA14_25ns_v1[3];   //[nel]
   Int_t           el_eleCutIdCSA14_50ns_v1[3];   //[nel]
   Double_t        el_dxy[3];   //[nel]
   Double_t        el_dz[3];   //[nel]
   Double_t        el_edxy[3];   //[nel]
   Double_t        el_edz[3];   //[nel]
   Double_t        el_ip3d[3];   //[nel]
   Double_t        el_sip3d[3];   //[nel]
   Int_t           el_convVeto[3];   //[nel]
   Int_t           el_lostHits[3];   //[nel]
   Double_t        el_relIso03[3];   //[nel]
   Double_t        el_relIso04[3];   //[nel]
   Double_t        el_miniRelIso[3];   //[nel]
   Double_t        el_relIsoAn04[3];   //[nel]
   Int_t           el_tightCharge[3];   //[nel]
   Int_t           el_mcMatchId[3];   //[nel]
   Int_t           el_mcMatchAny[3];   //[nel]
   Int_t           el_mcMatchTau[3];   //[nel]
   Double_t        el_mcPt[3];   //[nel]
   Int_t           el_mediumMuonId[3];   //[nel]
   Int_t           el_pdgId[3];   //[nel]
   Double_t        el_pt[3];   //[nel]
   Double_t        el_eta[3];   //[nel]
   Double_t        el_phi[3];   //[nel]
   Double_t        el_mass[3];   //[nel]
   Int_t           el_eleMVAId[3];   //[nel]
   Double_t        el_mvaId[3];   //[nel]
   Double_t        el_corrGsfTrack[3];   //[nel]
   Double_t        el_passConversionVeto[3];   //[nel]
   Double_t        el_mvaIdTrig[3];   //[nel]
   Double_t        el_looseId[3];   //[nel]
   Double_t        el_validFraction[3];   //[nel]
   Double_t        el_globalMuon[3];   //[nel]
   Double_t        el_isTrackerMuon[3];   //[nel]
   Double_t        el_isPFMuon[3];   //[nel]
   Double_t        el_normChi2Track[3];   //[nel]
   Double_t        el_trackPosMatch[3];   //[nel]
   Double_t        el_kickFinder[3];   //[nel]
   Double_t        el_segmentComp[3];   //[nel]
   Double_t        el_chargedHadrIsoR03[3];   //[nel]
   Double_t        el_chargedHadrIsoR04[3];   //[nel]
   Double_t        el_neutralHadrIsoR03[3];   //[nel]
   Double_t        el_neutralHadrIsoR04[3];   //[nel]
   Double_t        el_photonIsoR03[3];   //[nel]
   Double_t        el_photonIsoR04[3];   //[nel]
   Double_t        el_puChargedHadronIsoR03[3];   //[nel]
   Double_t        el_puChargedHadronIsoR04[3];   //[nel]
   Double_t        el_mvaIdSpring15NonTrig[3];   //[nel]
   Double_t        el_POG_PHYS14_25ns_v1_Veto[3];   //[nel]
   Double_t        el_superClusterEta[3];   //[nel]
   Int_t           nmu;
   Int_t           mu_charge[3];   //[nmu]
   Int_t           mu_tightId[3];   //[nmu]
   Int_t           mu_eleCutIdCSA14_25ns_v1[3];   //[nmu]
   Int_t           mu_eleCutIdCSA14_50ns_v1[3];   //[nmu]
   Double_t        mu_dxy[3];   //[nmu]
   Double_t        mu_dz[3];   //[nmu]
   Double_t        mu_edxy[3];   //[nmu]
   Double_t        mu_edz[3];   //[nmu]
   Double_t        mu_ip3d[3];   //[nmu]
   Double_t        mu_sip3d[3];   //[nmu]
   Int_t           mu_convVeto[3];   //[nmu]
   Int_t           mu_lostHits[3];   //[nmu]
   Double_t        mu_relIso03[3];   //[nmu]
   Double_t        mu_relIso04[3];   //[nmu]
   Double_t        mu_miniRelIso[3];   //[nmu]
   Double_t        mu_relIsoAn04[3];   //[nmu]
   Int_t           mu_tightCharge[3];   //[nmu]
   Int_t           mu_mcMatchId[3];   //[nmu]
   Int_t           mu_mcMatchAny[3];   //[nmu]
   Int_t           mu_mcMatchTau[3];   //[nmu]
   Double_t        mu_mcPt[3];   //[nmu]
   Int_t           mu_mediumMuonId[3];   //[nmu]
   Int_t           mu_pdgId[3];   //[nmu]
   Double_t        mu_pt[3];   //[nmu]
   Double_t        mu_eta[3];   //[nmu]
   Double_t        mu_phi[3];   //[nmu]
   Double_t        mu_mass[3];   //[nmu]
   Int_t           mu_eleMVAId[3];   //[nmu]
   Double_t        mu_mvaId[3];   //[nmu]
   Double_t        mu_corrGsfTrack[3];   //[nmu]
   Double_t        mu_passConversionVeto[3];   //[nmu]
   Double_t        mu_mvaIdTrig[3];   //[nmu]
   Double_t        mu_looseId[3];   //[nmu]
   Double_t        mu_validFraction[3];   //[nmu]
   Double_t        mu_globalMuon[3];   //[nmu]
   Double_t        mu_isTrackerMuon[3];   //[nmu]
   Double_t        mu_isPFMuon[3];   //[nmu]
   Double_t        mu_normChi2Track[3];   //[nmu]
   Double_t        mu_trackPosMatch[3];   //[nmu]
   Double_t        mu_kickFinder[3];   //[nmu]
   Double_t        mu_segmentComp[3];   //[nmu]
   Double_t        mu_chargedHadrIsoR03[3];   //[nmu]
   Double_t        mu_chargedHadrIsoR04[3];   //[nmu]
   Double_t        mu_neutralHadrIsoR03[3];   //[nmu]
   Double_t        mu_neutralHadrIsoR04[3];   //[nmu]
   Double_t        mu_photonIsoR03[3];   //[nmu]
   Double_t        mu_photonIsoR04[3];   //[nmu]
   Double_t        mu_puChargedHadronIsoR03[3];   //[nmu]
   Double_t        mu_puChargedHadronIsoR04[3];   //[nmu]
   Double_t        mu_mvaIdSpring15NonTrig[3];   //[nmu]
   Double_t        mu_POG_PHYS14_25ns_v1_Veto[3];   //[nmu]
   Double_t        mu_superClusterEta[3];   //[nmu]
   Int_t           ntau;
   Int_t           tau_charge[6];   //[ntau]
   Int_t           tau_decayMode[6];   //[ntau]
   Int_t           tau_idDecayMode[6];   //[ntau]
   Int_t           tau_idDecayModeNewDMs[6];   //[ntau]
   Double_t        tau_dxy[6];   //[ntau]
   Double_t        tau_dz[6];   //[ntau]
   Int_t           tau_idMVA[6];   //[ntau]
   Int_t           tau_idMVANewDM[6];   //[ntau]
   Int_t           tau_idCI3hit[6];   //[ntau]
   Int_t           tau_idAntiMu[6];   //[ntau]
   Int_t           tau_idAntiE[6];   //[ntau]
   Double_t        tau_isoCI3hit[6];   //[ntau]
   Int_t           tau_mcMatchId[6];   //[ntau]
   Int_t           tau_pdgId[6];   //[ntau]
   Double_t        tau_pt[6];   //[ntau]
   Double_t        tau_eta[6];   //[ntau]
   Double_t        tau_phi[6];   //[ntau]
   Double_t        tau_mass[6];   //[ntau]
   Int_t           tau_againstElectronLooseMVA5[6];   //[ntau]
   Int_t           tau_againstElectronMediumMVA5[6];   //[ntau]
   Int_t           tau_againstElectronTightMVA5[6];   //[ntau]
   Int_t           tau_againstElectronVLooseMVA5[6];   //[ntau]
   Int_t           tau_againstElectronVTightMVA5[6];   //[ntau]
   Int_t           tau_againstMuonLoose3[6];   //[ntau]
   Int_t           tau_againstMuonTight3[6];   //[ntau]
   Double_t        tau_byCombinedIsolationDeltaBetaCorrRaw3Hits[6];   //[ntau]
   Int_t           tau_byLooseCombinedIsolationDeltaBetaCorr3Hits[6];   //[ntau]
   Int_t           tau_byMediumCombinedIsolationDeltaBetaCorr3Hits[6];   //[ntau]
   Int_t           tau_byTightCombinedIsolationDeltaBetaCorr3Hits[6];   //[ntau]
   Double_t        tau_byIsolationMVA3newDMwLTraw[6];   //[ntau]
   Double_t        tau_byIsolationMVA3oldDMwLTraw[6];   //[ntau]
   Int_t           tau_decayModeFinding[6];   //[ntau]
   Int_t           tau_decayModeFindingNewDMs[6];   //[ntau]
   Double_t        tau_chargedIsoPtSum[6];   //[ntau]
   Double_t        tau_packedLeadTauCanddXY[6];   //[ntau]
   Double_t        tau_packedLeadTauCanddZ[6];   //[ntau]
   Int_t           ndilepton;
   Double_t        dilepton_pt[14];   //[ndilepton]
   Double_t        dilepton_eta[14];   //[ndilepton]
   Double_t        dilepton_phi[14];   //[ndilepton]
   Double_t        dilepton_mass[14];   //[ndilepton]
   Double_t        dilepton_svfitMass[14];   //[ndilepton]
   Double_t        dilepton_svfitMassError[14];   //[ndilepton]
   Double_t        dilepton_svfitPt[14];   //[ndilepton]
   Double_t        dilepton_svfitPtError[14];   //[ndilepton]
   Double_t        dilepton_svfitEta[14];   //[ndilepton]
   Double_t        dilepton_svfitPhi[14];   //[ndilepton]
   Double_t        dilepton_metsig00[14];   //[ndilepton]
   Double_t        dilepton_metsig01[14];   //[ndilepton]
   Double_t        dilepton_metsig10[14];   //[ndilepton]
   Double_t        dilepton_metsig11[14];   //[ndilepton]
   Double_t        dilepton_l1_pt[14];   //[ndilepton]
   Double_t        dilepton_l1_eta[14];   //[ndilepton]
   Double_t        dilepton_l1_phi[14];   //[ndilepton]
   Double_t        dilepton_l1_mass[14];   //[ndilepton]
   Double_t        dilepton_l2_pt[14];   //[ndilepton]
   Double_t        dilepton_l2_eta[14];   //[ndilepton]
   Double_t        dilepton_l2_phi[14];   //[ndilepton]
   Double_t        dilepton_l2_mass[14];   //[ndilepton]
   Double_t        dilepton_met_pt[14];   //[ndilepton]
   Double_t        dilepton_met_phi[14];   //[ndilepton]
